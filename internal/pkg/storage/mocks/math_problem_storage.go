...
func (_m *MathProblemStorage) CreateMathProblem(ctx context.Context, mathProblem mysql.MathProblem) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, mysql.MathProblem) (int, error)); ok {
...
func (_c *MathProblemStorage_CreateMathProblem_Call) RunAndReturn(run func(context.Context, mysql.MathProblem) (int, error)) *MathProblemStorage_CreateMathProblem_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MathProblemStorage) GetMathProblemByGameID(ctx context.Context, gameID int) ([]*mysql.MathProblem, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) ([]*mysql.MathProblem, error)); ok {
...
func (_c *MathProblemStorage_GetMathProblemByGameID_Call) RunAndReturn(run func(context.Context, int) ([]*mysql.MathProblem, error)) *MathProblemStorage_GetMathProblemByGameID_Call {
	_c.Call.Return(run)
	return _c
}
