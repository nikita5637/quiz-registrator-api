...
func (_m *UserStorage) GetUserByID(ctx context.Context, userID int) (*mysql.User, error) {
	...
	var r0 *mysql.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*mysql.User, error)); ok {
...
func (_c *UserStorage_GetUserByID_Call) RunAndReturn(run func(context.Context, int) (*mysql.User, error)) *UserStorage_GetUserByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserStorage) GetUserByTelegramID(ctx context.Context, telegramID int64) (*mysql.User, error) {
	...
	var r0 *mysql.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) (*mysql.User, error)); ok {
...
func (_c *UserStorage_GetUserByTelegramID_Call) RunAndReturn(run func(context.Context, int64) (*mysql.User, error)) *UserStorage_GetUserByTelegramID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserStorage) Insert(ctx context.Context, user mysql.User) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, mysql.User) (int, error)); ok {
		return rf(ctx, user)
	}
...
func (_c *UserStorage_Insert_Call) RunAndReturn(run func(context.Context, mysql.User) (int, error)) *UserStorage_Insert_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserStorage_PatchUser_Call) RunAndReturn(run func(context.Context, mysql.User) error) *UserStorage_PatchUser_Call {
	_c.Call.Return(run)
	return _c
}
