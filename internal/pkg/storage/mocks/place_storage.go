...
func (_m *PlaceStorage) Find(ctx context.Context, q builder.Cond, sort string) ([]model.Place, error) {
	ret := _m.Called(ctx, q, sort)

	var r0 []model.Place
	if rf, ok := ret.Get(0).(func(context.Context, builder.Cond, string) []model.Place); ok {
		r0 = rf(ctx, q, sort)
	} else {
		if ret.Get(0) != nil {
...
// PlaceStorage_Find_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Find'
type PlaceStorage_Find_Call struct {
	*mock.Call
}
...
//  - q builder.Cond
//  - sort string
func (_e *PlaceStorage_Expecter) Find(ctx interface{}, q interface{}, sort interface{}) *PlaceStorage_Find_Call {
	return &PlaceStorage_Find_Call{Call: _e.mock.On("Find", ctx, q, sort)}
}

func (_c *PlaceStorage_Find_Call) Run(run func(ctx context.Context, q builder.Cond, sort string)) *PlaceStorage_Find_Call {
...
func (_c *PlaceStorage_Find_Call) Return(_a0 []model.Place, _a1 error) *PlaceStorage_Find_Call {
