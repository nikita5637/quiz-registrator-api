...
func (_m *PlaceStorage) CreatePlace(ctx context.Context, place mysql.Place) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, mysql.Place) (int, error)); ok {
		return rf(ctx, place)
	}
...
func (_c *PlaceStorage_CreatePlace_Call) RunAndReturn(run func(context.Context, mysql.Place) (int, error)) *PlaceStorage_CreatePlace_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *PlaceStorage) GetPlaceByID(ctx context.Context, id int32) (model.Place, error) {
	...
	var r0 model.Place
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int32) (model.Place, error)); ok {
		return rf(ctx, id)
	}
...
func (_c *PlaceStorage_GetPlaceByID_Call) RunAndReturn(run func(context.Context, int32) (model.Place, error)) *PlaceStorage_GetPlaceByID_Call {
	_c.Call.Return(run)
	return _c
}
