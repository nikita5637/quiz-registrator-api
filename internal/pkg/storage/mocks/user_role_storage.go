...
func (_c *UserRoleStorage_DeleteUserRole_Call) RunAndReturn(run func(context.Context, int) error) *UserRoleStorage_DeleteUserRole_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserRoleStorage) GetUserRoleByID(ctx context.Context, userRoleID int) (*mysql.UserRole, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*mysql.UserRole, error)); ok {
		return rf(ctx, userRoleID)
	}
...
func (_c *UserRoleStorage_GetUserRoleByID_Call) RunAndReturn(run func(context.Context, int) (*mysql.UserRole, error)) *UserRoleStorage_GetUserRoleByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserRoleStorage) GetUserRoles(ctx context.Context) ([]mysql.UserRole, error) {
	...
	var r0 []mysql.UserRole
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]mysql.UserRole, error)); ok {
		return rf(ctx)
	}
...
func (_c *UserRoleStorage_GetUserRoles_Call) RunAndReturn(run func(context.Context) ([]mysql.UserRole, error)) *UserRoleStorage_GetUserRoles_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserRoleStorage_GetUserRolesByUserID_Call) RunAndReturn(run func(context.Context, int) ([]mysql.UserRole, error)) *UserRoleStorage_GetUserRolesByUserID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserRoleStorage) Insert(ctx context.Context, userRole mysql.UserRole) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, mysql.UserRole) (int, error)); ok {
...
func (_c *UserRoleStorage_Insert_Call) RunAndReturn(run func(context.Context, mysql.UserRole) (int, error)) *UserRoleStorage_Insert_Call {
	_c.Call.Return(run)
	return _c
}
