...
func (_m *LeagueStorage) CreateLeague(ctx context.Context, league mysql.League) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, mysql.League) (int, error)); ok {
		return rf(ctx, league)
	}
...
func (_c *LeagueStorage_CreateLeague_Call) RunAndReturn(run func(context.Context, mysql.League) (int, error)) *LeagueStorage_CreateLeague_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *LeagueStorage_GetLeagueByID_Call) RunAndReturn(run func(context.Context, int32) (model.League, error)) *LeagueStorage_GetLeagueByID_Call {
	_c.Call.Return(run)
	return _c
}
