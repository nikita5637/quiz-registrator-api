...
func (_m *CertificateStorage) CreateCertificate(ctx context.Context, certificate mysql.Certificate) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, mysql.Certificate) (int, error)); ok {
...
func (_c *CertificateStorage_CreateCertificate_Call) RunAndReturn(run func(context.Context, mysql.Certificate) (int, error)) *CertificateStorage_CreateCertificate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CertificateStorage_DeleteCertificate_Call) RunAndReturn(run func(context.Context, int) error) *CertificateStorage_DeleteCertificate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CertificateStorage) GetCertificateByID(ctx context.Context, id int) (*mysql.Certificate, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*mysql.Certificate, error)); ok {
		return rf(ctx, id)
	}
...
func (_c *CertificateStorage_GetCertificateByID_Call) RunAndReturn(run func(context.Context, int) (*mysql.Certificate, error)) *CertificateStorage_GetCertificateByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CertificateStorage_GetCertificates_Call) RunAndReturn(run func(context.Context) ([]mysql.Certificate, error)) *CertificateStorage_GetCertificates_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CertificateStorage_PatchCertificate_Call) RunAndReturn(run func(context.Context, mysql.Certificate) error) *CertificateStorage_PatchCertificate_Call {
	_c.Call.Return(run)
	return _c
}
