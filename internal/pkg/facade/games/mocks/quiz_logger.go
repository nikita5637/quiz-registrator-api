...
// WriteBatch provides a mock function with given fields: ctx, params
func (_m *QuizLogger) WriteBatch(ctx context.Context, params []quizlogger.Params) error {
	ret := _m.Called(ctx, params)
...
// QuizLogger_WriteBatch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WriteBatch'
type QuizLogger_WriteBatch_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - params []quizlogger.Params
func (_e *QuizLogger_Expecter) WriteBatch(ctx interface{}, params interface{}) *QuizLogger_WriteBatch_Call {
	return &QuizLogger_WriteBatch_Call{Call: _e.mock.On("WriteBatch", ctx, params)}
}

func (_c *QuizLogger_WriteBatch_Call) Run(run func(ctx context.Context, params []quizlogger.Params)) *QuizLogger_WriteBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]quizlogger.Params))
	})
	return _c
...
func (_c *QuizLogger_WriteBatch_Call) Return(_a0 error) *QuizLogger_WriteBatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *QuizLogger_WriteBatch_Call) RunAndReturn(run func(context.Context, []quizlogger.Params) error) *QuizLogger_WriteBatch_Call {
	_c.Call.Return(run)
	return _c
}
