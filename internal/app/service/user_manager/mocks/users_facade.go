...
func (_c *UsersFacade_CreateUser_Call) RunAndReturn(run func(context.Context, model.User) (model.User, error)) *UsersFacade_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UsersFacade_GetUser_Call) RunAndReturn(run func(context.Context, int32) (model.User, error)) *UsersFacade_GetUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UsersFacade_GetUserByTelegramID_Call) RunAndReturn(run func(context.Context, int64) (model.User, error)) *UsersFacade_GetUserByTelegramID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UsersFacade_PatchUser_Call) RunAndReturn(run func(context.Context, model.User) (model.User, error)) *UsersFacade_PatchUser_Call {
	_c.Call.Return(run)
	return _c
}
