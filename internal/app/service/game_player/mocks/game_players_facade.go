...
func (_m *GamePlayersFacade) CreateGamePlayer(ctx context.Context, gamePlayer model.GamePlayer) (model.GamePlayer, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.GamePlayer) (model.GamePlayer, error)); ok {
...
func (_c *GamePlayersFacade_CreateGamePlayer_Call) RunAndReturn(run func(context.Context, model.GamePlayer) (model.GamePlayer, error)) *GamePlayersFacade_CreateGamePlayer_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *GamePlayersFacade_DeleteGamePlayer_Call) RunAndReturn(run func(context.Context, int32) error) *GamePlayersFacade_DeleteGamePlayer_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GamePlayersFacade) GetGamePlayer(ctx context.Context, id int32) (model.GamePlayer, error) {
	...
	var r0 model.GamePlayer
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int32) (model.GamePlayer, error)); ok {
		return rf(ctx, id)
	}
...
func (_c *GamePlayersFacade_GetGamePlayer_Call) RunAndReturn(run func(context.Context, int32) (model.GamePlayer, error)) *GamePlayersFacade_GetGamePlayer_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *GamePlayersFacade_GetGamePlayersByFields_Call) RunAndReturn(run func(context.Context, model.GamePlayer) ([]model.GamePlayer, error)) *GamePlayersFacade_GetGamePlayersByFields_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *GamePlayersFacade_GetGamePlayersByGameID_Call) RunAndReturn(run func(context.Context, int32) ([]model.GamePlayer, error)) *GamePlayersFacade_GetGamePlayersByGameID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *GamePlayersFacade_GetUserGameIDs_Call) RunAndReturn(run func(context.Context, int32) ([]int32, error)) *GamePlayersFacade_GetUserGameIDs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *GamePlayersFacade_PatchGamePlayer_Call) RunAndReturn(run func(context.Context, model.GamePlayer) (model.GamePlayer, error)) *GamePlayersFacade_PatchGamePlayer_Call {
	_c.Call.Return(run)
	return _c
}
