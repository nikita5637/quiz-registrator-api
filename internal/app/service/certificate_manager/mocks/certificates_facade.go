...
func (_m *CertificatesFacade) CreateCertificate(ctx context.Context, certificate model.Certificate) (model.Certificate, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.Certificate) (model.Certificate, error)); ok {
...
func (_c *CertificatesFacade_CreateCertificate_Call) RunAndReturn(run func(context.Context, model.Certificate) (model.Certificate, error)) *CertificatesFacade_CreateCertificate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CertificatesFacade_DeleteCertificate_Call) RunAndReturn(run func(context.Context, int32) error) *CertificatesFacade_DeleteCertificate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CertificatesFacade) GetCertificate(ctx context.Context, id int32) (model.Certificate, error) {
	...
	var r0 model.Certificate
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int32) (model.Certificate, error)); ok {
		return rf(ctx, id)
	}
...
func (_c *CertificatesFacade_GetCertificate_Call) RunAndReturn(run func(context.Context, int32) (model.Certificate, error)) *CertificatesFacade_GetCertificate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CertificatesFacade_ListCertificates_Call) RunAndReturn(run func(context.Context) ([]model.Certificate, error)) *CertificatesFacade_ListCertificates_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CertificatesFacade_PatchCertificate_Call) RunAndReturn(run func(context.Context, model.Certificate) (model.Certificate, error)) *CertificatesFacade_PatchCertificate_Call {
	_c.Call.Return(run)
	return _c
}
