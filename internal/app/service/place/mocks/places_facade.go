...
func (_c *PlacesFacade_GetPlaceByID_Call) RunAndReturn(run func(context.Context, int32) (model.Place, error)) *PlacesFacade_GetPlaceByID_Call {
	_c.Call.Return(run)
	return _c
}
