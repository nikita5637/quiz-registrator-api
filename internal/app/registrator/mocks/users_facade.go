...
func (_m *UsersFacade) CreateUser(ctx context.Context, user model.User) (int32, error) {
...
func (_m *UsersFacade) GetUser(ctx context.Context) (model.User, error) {
	ret := _m.Called(ctx)
...
//  - ctx context.Context
func (_e *UsersFacade_Expecter) GetUser(ctx interface{}) *UsersFacade_GetUser_Call {
	return &UsersFacade_GetUser_Call{Call: _e.mock.On("GetUser", ctx)}
}

func (_c *UsersFacade_GetUser_Call) Run(run func(ctx context.Context)) *UsersFacade_GetUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *UsersFacade) UpdateUserState(ctx context.Context, userID int32, state model.UserState) error {
	ret := _m.Called(ctx, userID, state)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int32, model.UserState) error); ok {
...
func (_c *UsersFacade_UpdateUserState_Call) Run(run func(ctx context.Context, userID int32, state model.UserState)) *UsersFacade_UpdateUserState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int32), args[2].(model.UserState))
	})
	return _c
}
